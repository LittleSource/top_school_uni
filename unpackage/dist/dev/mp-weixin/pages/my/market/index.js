      ...
      success: function success(res) {
        if (res.data.status === 200) {
          ...
          if (_this.merchant === 1) {
            ...
            _this.img = 'https://yuange666.oss-cn-beijing.aliyuncs.com/app/pageinfo/noShop.png',
            _this.text1 = '亲，您还没有开通店铺',
            _this.text2 = '如果您拥有超市可以点击下方按钮申请开通';
          }
        } else {
          uni.showToast({
            title: res.data.msg,
...
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/my/market/index.js.map